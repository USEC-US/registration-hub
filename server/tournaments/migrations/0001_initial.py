            ...
            options={
                "constraints": [
                    models.UniqueConstraint(
                        fields=("tournament", "game"), name="unique_tournament_game"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("team_size_min__gte", 1)),
                        name="tournament_game_min_team_size_positive",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(
                            ("team_size_max__gte", models.F("team_size_min"))
                        ),
                    ...
                    models.CheckConstraint(
                        condition=models.Q(
                            ("registration_capacity__isnull", True),
                            ("registration_capacity__gt", 0),
                            _connector="OR",
                        ),
